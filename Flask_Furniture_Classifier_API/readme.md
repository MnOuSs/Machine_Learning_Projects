...
```bash
curl -X POST -F "file=@images/test/001.jpeg" http://127.0.0.1:5000/predict
```
...
**Example**
```bash
curl -X POST -F "file=@images/test/001.jpeg" https://flask-furniture-classifier-api.onrender.com/predict
```
**Result**
```bash
